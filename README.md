...
methodology is selected. Find has no roles. Composer Tab completes this
grammar: workflow names, roles, `xai-auth`/`openai-codex`, `grok-4.6` /
`gpt-5.6-sol`, and the public efforts for that model.
