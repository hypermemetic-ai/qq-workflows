...
export const RESEARCH_REVIEW_PROMPT = [
  ...
  "Inspect only the supplied question, answer, manifest, materialized evidence, and repository files with grep, glob, and view. You cannot retrieve new web or session evidence.",
...
function reviewTask({ question, answer, manifest }) {
  ...
  return [
    ...
    manifestText,
    "",
    "Use the capsule oracle for focused checks. Do not request or perform new retrieval.",
