...
export function renderMiniReviewTask({ task, diff } = {}) {
  return [
    ...
    String(diff ?? ""),
    "</diff>",
    "You can inspect the repository with read-only tools when needed.",
    "",
    "Recommended Workflow",
    "",
    "1. Analyze the complete diff and understand the behavior it changes.",
    ...
    "4. Inspect only the repository context needed to answer that question.",
    ...
    "Rules",
    "",
    "- Start from the diff. Do not explore the repository for general understanding.",
    '- When a location is unknown, narrow it with "grep" or "glob" before reading.',
    "- When a location is known, read only the smallest useful range.",
