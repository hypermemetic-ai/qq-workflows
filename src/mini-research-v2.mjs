...
export function renderMiniResearchTask() {
  return [
    ...
    "```",
    "",
    "For compacted current-session context, search session_history with 1–5 literal clues, expand an exact seq with context, then verify referenced files/current state.",
