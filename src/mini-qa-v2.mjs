...
export const MINI_QA_TOOL_NAMES = Object.freeze(["bash", "submit_review", "workflow_send", "session_history"]);
...
export function renderMiniQaTask({ task } = {}) {
  return [
    ...
    "- Every response must call bash, workflow_send, session_history, or submit_review.",
