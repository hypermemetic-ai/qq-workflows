...
export function renderMiniSweTask(task, info) {
  ...
  return [
    ...
    "This checkout has no writable Git metadata or network credentials. The host exclusively stages, commits, tests when needed, and publishes after QA.",
    ...
    `6. Optionally call run_tests once, then submit your ordinary file edits for host commit by issuing: \`${MINI_SWE_COMPLETION_COMMAND}\`.`,
    ...
    "- Your response MUST include at least one bash or run_tests tool call",
