# Initial conversation-retention measurement

The selected policy is a **2,048-token conversation floor**, retaining at least the current and previous exchanges. The first replay found 1,024 was the smallest tested floor that avoided the measured short-turn losses; 2,048 was the operator’s final choice. This measurement does not establish an optimum for answer quality.
