...
import { createProviderProxy } from '../../paseo-plugin/host/provider-proxy.mjs';
import { reconcileWithSdk } from '../../paseo-plugin/host/spawn-agent.mjs';
import { mapOcrJson } from '../../paseo-plugin/host/ocr.mjs';
...
const { createTextGuard } = await import('../../paseo-plugin/host/text-loop.mjs');
