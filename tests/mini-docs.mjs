...
assert.deepEqual(Object.keys(mounted.registeredTools[0].parameters.properties), ["command", "writable_paths"]);
assert.equal(mounted.registeredTools[0].parameters.properties.writable_paths.type, "array");
