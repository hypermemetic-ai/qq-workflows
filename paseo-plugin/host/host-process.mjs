#!/usr/bin/env node
import { createRuntime, HOST_STATE_DIR, readHostMeta } from './runtime.mjs';
import { join } from 'node:path';
const runtime = createRuntime({ storePath: join(HOST_STATE_DIR, 'state.sqlite'), onIdleUpgrade: async () => { await runtime.close(); process.exit(0); } });
