...
export const ZVEC_GREP_INDEX = Object.freeze({
...
export const ZVEC_GREP_INDEX_DROP = Object.freeze({
...
export const ZVEC_GREP_INDEX_STATUS = Object.freeze({
...
export const ZVEC_GREP_SERVER_STATUS = Object.freeze({
...
export const ZG_WHITELIST = Object.freeze([
  ...
  ZVEC_GREP_RG.name,
  ZVEC_GREP_INDEX.name,
  ZVEC_GREP_INDEX_DROP.name,
  ZVEC_GREP_INDEX_STATUS.name,
  ZVEC_GREP_SERVER_STATUS.name,
]);

export const ZG_STDIO_COMMAND = Object.freeze({
  command: "zg",
  args: Object.freeze(["server", "--stdio", "--mcp-toolset", "full"]),
});
